...
<div class="right_col" role="main">
    ...
    <div class="page-content-wrap">
        <div class="row">
            <div class="col-md-12">
                <form action="{{url('template/welcome-mail')}}" class="form-horizontal" method="post" onsubmit="return updateInvoice(this)">
                    <div class="panel panel-default">
                        <div class="x_title">
                            <div class="col-md-6">
                                <h3>Welcome Mail <small>Template</small></h3>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="panel-body">                                                                        
                            <div class="row">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="subject"  class="form-control" id="subject" value="{{$welcome->subject or ''}}" >
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="name"  class="form-control" id="name" value="{{$welcome->name or ''}}" >
                                 ...
                                 <div class="form-group has-feedback">
                                        @php 
                                            ...
                                            if(isset($welcome->photo) && $welcome->photo){
                                                $img = "/storage/app/".$welcome->photo->full_path;
                                            }
                                        @endphp
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="hidden" name="photo_id" value="{{$welcome->photo_id or ''}}">
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="header_text"  class="form-control" id="header_text" value="{{$welcome->header_text or ''}}" >
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <textarea name="body" id="body" class="body" >{{$welcome->body or ''}}</textarea>
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="signature"  class="form-control" id="signature" value="{{$welcome->signature or ''}}" >
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="footer_text"  class="form-control" id="footer_text" value="{{$welcome->footer_text or ''}}" >
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="footer_website_link"  class="form-control" id="footer_website_link" value="{{$welcome->footer_website_link or ''}}" >
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="footer_phone_no"  class="form-control" id="footer_phone_no" value="{{$welcome->footer_phone_no or ''}}" >
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="building_no"  class="form-control" id="building_no" value="{{$welcome->building_no or ''}}" >
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="street_name"  class="form-control" id="street_name" value="{{$welcome->street_name or ''}}" >
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="suburb"  class="form-control" id="suburb" value="{{$welcome->suburb or ''}}" >
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control select" name="state" id="state">
                                            ...
                                            @if(isset($welcome->state) && $welcome->state)
                                            <option value="{{$welcome->state}}" selected>{{$welcome->state}}</option>
                                            @endif
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="post_code"  class="form-control" id="post_code" value="{{$welcome->post_code or ''}}" >
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="country"  class="form-control" id="country" value="{{$welcome->country or ''}}" >
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">                                                                        
                            ...
                            <div class="row" id="preview-div">
                                @include('template.preview.welcome-mail')
                            </div>
                    </div>
                </div>
            </div>
...
@endsection
@push('script')
<script src="{{asset('public/js/template/welcome-mail.js?d='.time())}}"></script>
@endpush