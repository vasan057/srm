<style type="text/css">
    ...
    <tbody>
        ...
        <table class="w580" width="580" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <p align="left" class="article-title"><singleline label="Title"> {{$reset->header_text or ''}}</singleline></p>
                        </td></tr>
        ...
        <span>
        <p align="justify" class="footer-content-left">{{$reset->footer_text or ''}}<br></p></span>
        </td>
    <td class="w30" width="30"></td>
       <td class="w0" width="160" valign="top">
       <p align="left" class="footer-content-right">
       <span>{{$reset->footer_website_link or ''}}</span><br>
       <span>admin@kandelconsultant.com</span><br>
       <span>{{$reset->footer_phone_no or ''}}</span></p>
       
      <p align="left" class="footer-content-right"><span>{{$reset->building_no or ''}} , {{$reset->street_name or ''}},</span><br>
       <span>{{$reset->suburb or ''}},</span><br>
       <span>{{$reset->state or ''}} - {{$reset->post_code or ''}} </span><br>
