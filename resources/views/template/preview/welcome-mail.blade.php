   ...
   <tbody>
      <tr>
         <td align="center" bgcolor="#ececec">
            <div class="h_line" style="width:100%; height:1px; background: #cccccc;"></div>
                              ...
                              <tr>
                                 ...
                                 <td class="w255" width="255" valign="middle" align="right">
                                    <table class="w255" width="255" cellpadding="0" cellspacing="0" border="0">
                                       <tbody>
                                          <tr>
                                             <td class="w255" width="255" height="28"></td>
                                          </tr>
                                       </tbody>
                                    </table>
                                 </td>
                  ...
                  <tr>
                     <td id="header" class="w640" width="640" align="center" bgcolor="#ffffff">
                        <div align="center" style="text-align: center">
                           <img id="customHeaderImage" label="Header Image" editable="true" width="150" src="{{$img}}" class="" border="0" align="top" style="display: inline">
                        </div>
                     </td>
                  </tr>
                  <tr>
                                          ...
                                          <tr>
                                             <td class="w580" width="580">
                                                <p align="left" class="article-title">
                                                   <singleline label="Title"> {{$welcome->header_text or ''}}</singleline>
                                                </p>
                                             </td>
                                          </tr>
                                          <tr>
                                             ...
                                             <td class="w580" width="580">
                                                <div align="left" class="article-content">
                                                   ...
                                                   <table  align="center" width="100%" cellpadding="0" cellspacing="0" style="font-family:Avenir, Helvetica, sans-serif;margin:30px auto;padding:0;text-align:center;width:100%;">
                                                      <tbody>
                                                         <tr>
                                                            <td align="left" style="font-family:Avenir, Helvetica, sans-serif;">
                                                               UserName : {{$username or ''}}
                                                            </td>
                                                         </tr>
                                                      </tbody>
                                                   </table><table  align="center" width="100%" cellpadding="0" cellspacing="0" style="font-family:Avenir, Helvetica, sans-serif;margin:30px auto;padding:0;text-align:center;width:100%;">
                                                      <tbody>
                                                         <tr>
                                                                              ...
                                                                              <tbody>
                                                                                 <tr>
                                                                                    <td style="font-family:Avenir, Helvetica, sans-serif;">
                                                                                       <a rel="nofollow" target="_blank" href="{{$link}}" style="font-family:Avenir, Helvetica, sans-serif;border-radius:3px;color:#FFF;display:inline-block;text-decoration:none;background-color:#3097D1;border-top:10px solid #3097D1;border-right:18px solid #3097D1;border-bottom:10px solid #3097D1;border-left:18px solid #3097D1;">Activaion</a>
                                                                                    </td>
                                                                                 </tr>
                                                                              </tbody>
                                                                           </table>
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td class="w580" width="580" valign="top">
                                    <span>
                                       <p align="justify" class="footer-content-left">{{$welcome->footer_text or ''}}<br></p>
                                    </span>
                                 </td>
                                 <td class="w30" width="30"></td>
                                 <td class="w0" width="160" valign="top">
                                    <p align="left" class="footer-content-right">
                                       <span>{{$welcome->footer_website_link or ''}}</span><br>
                                       <span>admin@kandelconsultant.com</span><br>
                                       <span>{{$welcome->footer_phone_no or ''}}</span>
                                    </p>
                                    <p align="left" class="footer-content-right"><span>{{$welcome->building_no or ''}} , {{$welcome->street_name or ''}},</span><br>
                                       <span>{{$welcome->suburb or ''}},</span><br>
                                       <span>{{$welcome->state or ''}} - {{$welcome->post_code or ''}} </span><br>
                                    </p>
                                 </td>
                              </tr>
                           </tbody>
