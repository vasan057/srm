...
<div class="right_col" role="main">
    ...
    <div class="page-content-wrap">
        <div class="row">
            <div class="col-md-12">
                <form action="{{url('template/lof-reminder')}}" class="form-horizontal" method="post" onsubmit="return updateInvoice(this)">
                    <div class="panel panel-default">
                        <div class="x_title">
                            <div class="col-md-6">
                                <h3>LOF Remider mail<small>Template</small></h3>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="panel-body">                                                                        
                            <div class="row">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="subject"  class="form-control" id="subject" value="{{$lof->subject or ''}}" >
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="name"  class="form-control" id="name" value="{{$lof->name or ''}}" >
                                 ...
                                 <div class="form-group has-feedback">
                                        @php 
                                            ...
                                            if(isset($lof->photo) && $lof->photo){
                                                $img = "/storage/app/".$lof->photo->full_path;
                                            }
                                        @endphp
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="hidden" name="photo_id" value="{{$lof->photo_id or ''}}">
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="header_text"  class="form-control" id="header_text" value="{{$lof->header_text or ''}}" >
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <textarea name="body" id="body" class="body" >{{$lof->body or ''}}</textarea>
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="signature"  class="form-control" id="signature" value="{{$lof->signature or ''}}" >
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="footer_text"  class="form-control" id="footer_text" value="{{$lof->footer_text or ''}}" >
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="footer_website_link"  class="form-control" id="footer_website_link" value="{{$lof->footer_website_link or ''}}" >
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="footer_phone_no"  class="form-control" id="footer_phone_no" value="{{$lof->footer_phone_no or ''}}" >
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="building_no"  class="form-control" id="building_no" value="{{$lof->building_no or ''}}" >
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="street_name"  class="form-control" id="street_name" value="{{$lof->street_name or ''}}" >
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="suburb"  class="form-control" id="suburb" value="{{$lof->suburb or ''}}" >
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control select" name="state" id="state">
                                            ...
                                            @if(isset($lof->state) && $lof->state)
                                            <option value="{{$lof->state}}" selected>{{$lof->state}}</option>
                                            @endif
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="post_code"  class="form-control" id="post_code" value="{{$lof->post_code or ''}}" >
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="country"  class="form-control" id="country" value="{{$lof->country or ''}}" >
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">                                                                        
                            ...
                            <div class="row" id="preview-div">
                                @include('template.preview.lof-reminder')
                            </div>
                    </div>
                </div>
            </div>
...
@endsection
@push('script')
<script src="{{asset('public/js/template/lof-reminder.js?d='.time())}}"></script>
@endpush